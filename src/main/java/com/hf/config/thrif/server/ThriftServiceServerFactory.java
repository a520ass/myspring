...
public class ThriftServiceServerFactory implements InitializingBean {
	...
	public void setThriftServerIpResolve(
	...
	public void afterPropertiesSet() throws Exception {
		...
		List<String> serverIPlist = thriftServerIpResolve.getServerIp();
		String serverIP = selectOptimalIP(serverIPlist);
		...
		if (thriftServerAddressRegister != null) {
			thriftServerAddressRegister
					.register(serviceName, version, hostname);
		}
