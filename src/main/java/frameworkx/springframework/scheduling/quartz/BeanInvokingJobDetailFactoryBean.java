 ...
 */
public class BeanInvokingJobDetailFactoryBean implements FactoryBean<JobDetail>,
	...
	public void afterPropertiesSet() throws Exception {
		try {
			...
			jobDetailImpl.setName(beanName);
			jobDetailImpl.setGroup(group);
			jobDetailImpl.setJobClass(concurrent ? BeanInvokingJob.class
					: StatefulBeanInvokingJob.class);
			jobDetailImpl.setDurability(durable);
			//jobDetailImpl.setVolatility(volatility);
			jobDetailImpl.setRequestsRecovery(shouldRecover);
			...
			/*if (this.jobListenerNames != null) {
				for (int i = 0; i < this.jobListenerNames.length; i++) {
					jobDetailImpl.addJobListener(this.jobListenerNames[i]);
				}
			}*/
	...
	//有状态的job
	@PersistJobDataAfterExecution	//持久化数据在执行之后
